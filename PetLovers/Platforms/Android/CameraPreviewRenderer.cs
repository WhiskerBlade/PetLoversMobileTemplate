...
using PetLovers.Platforms.Android;
...
[assembly: ExportRenderer(typeof(PetLovers.Views.CameraPage), typeof(CameraPreviewRenderer))]
namespace PetLovers.Platforms.Android
{
    public class CameraPreviewRenderer : FrameLayout, IVisualElementRenderer, IViewRenderer, TextureView.ISurfaceTextureListener, Camera.IPreviewCallback, Handler.ICallback
    {
        ...
        void SetupUserInterface()
        {
            ...
            view = activity.LayoutInflater.Inflate(_Microsoft.Android.Resource.Designer.ResourceConstant.Layout.CameraLayout, this, false);
        ...
        public bool HandleMessage(Message msg)
        {
            if (msg.What == 100)
            {
                ...
                Element.NotifyResultReady("ggg", previewWidth, previewHeight);
                isReady = true;
            }
